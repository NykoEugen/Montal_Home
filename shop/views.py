...
def home(request):
    ...
    return render(request, 'shop/home.html', {'categories': categories, 'furniture': furniture})
...
def add_to_cart(request, furniture_id):
    ...
    return JsonResponse({'message': f'{furniture.name} додано до кошика!', 'cart_count': sum(cart.values())})
