...
def breadcrumbs(request):
    ...
    if view_name == 'categories:categories_list':
        ...
        try:
            ...
            breadcrumbs.append({'name': 'Каталог', 'url': '/catalogue/'})
            breadcrumbs.append({'name': category.name, 'url': f'/catalogue/{category.slug}/'})
        ...
        try:
            ...
            breadcrumbs.append({'name': sub_category.name, 'url': f'/sub-categories/{sub_category.slug}/'})
        ...
        try:
            ...
            breadcrumbs.append({'name': furniture.name, 'url': f'/furniture/{furniture.slug}/'})
